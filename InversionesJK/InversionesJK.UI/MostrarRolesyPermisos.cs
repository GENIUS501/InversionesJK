...
{
    public partial class MostrarRolesyPermisos : Form
    {
        int valorcelda = -1;
        public int Usuario { get; set; }
        public int Id_Rol { get; set; }
        public MostrarRolesyPermisos()
        {
            InitializeComponent();
        }

        private void MostrarRolesyPermisos_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                if (valorcelda != -1)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        valorcelda = -1;
                        MostrarRolesyPermisos_Load(null, null);
                    }
                }
                else
                {
